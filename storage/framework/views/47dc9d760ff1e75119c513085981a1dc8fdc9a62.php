<nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="<?php echo e(url('/show_product')); ?>">Show Products</a></li>
      ...
      </nav><?php /**PATH C:\Users\quan\Desktop\EcommercePro\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>