...
<script src="admin/assets/js/off-canvas.js')}}"></script>
    ...
    <script src="<?php echo e(asset('admin/assets/js/dashboard.js')); ?>"></script><?php /**PATH C:\Users\quan\Desktop\EcommercePro\resources\views/admin/script.blade.php ENDPATH**/ ?>